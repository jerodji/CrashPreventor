...
//            CPLog(@"warning, -[__NSPlaceholderDictionary initWithObjects:forKeys:count:], objects or keys is nil");
...
//                newCnt++;
//            } else {
//                CPLog(@"warning, -[__NSPlaceholderArray initWithObjects:forKeys:count:], object cannot be nil at %d", i);
//            }
//        }
...
//    else
//    {
//        CPLog(@"warning, -[__NSPlaceholderArray initWithObjects:forKeys:], object, keys cannot be nil; or objects and keys count not equal.");
